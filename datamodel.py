...
class ConversionObservation:
    ...
    def __init__(self, bidPrice: float, askPrice: float, transportFees: float,
        ...
        self.sugarPrice = sunlight
        self.sunlightIndex = humidity
...
class Trade:
    ...
    def __str__(self) -> str:
        return ("(" + self.symbol + ", " + self.buyer + " << " +
                self.seller + ", " + str(self.price) + ", " +
                str(self.quantity) + ", " + str(self.timestamp) + ")")

    def __repr__(self) -> str:
        return ("(" + self.symbol + ", " + self.buyer + " << " +
                self.seller + ", " + str(self.price) + ", " +
                str(self.quantity) + ", " + str(self.timestamp) + ")" +
                self.symbol + ", " + self.buyer + " << " +
                self.seller + ", " + str(self.price) + ", " +
                str(self.quantity) + ")")
